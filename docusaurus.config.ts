      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: "right",
            value: `
            <a href="https://github.com/longbridgeapp/wiki-docs" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:26px;height:26px" title="LongPort SDK OpenSource">
